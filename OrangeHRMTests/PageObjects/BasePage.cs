...
namespace OrangeHRMTests.PageObjects
{
    public class BasePage
    {
        ...
        public const string DropDownListArrowButtonByName = "//*[contains(@class, 'wrapper')]/*[contains(text(), '{0}')]//ancestor::div[contains(@class, 'wrapper')]//following-sibling::div[1]//i";
        public const string XPathInputTextFieldByName = "//*[contains(@class, 'input-field')]//*[contains(text(), '{0}')]//ancestor::div[1]//following-sibling::div[1]//input";
