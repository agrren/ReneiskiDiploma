...
namespace OrangeHRMTests.PageObjects.Pages
{
    public class AdminPage : BasePage
    {
        ...
        public string GetJobTitlesText() => GetMainTitleText();

        public string GetNationalitiesText() => GetMainTitleText();

        public string GetEditNationalitiyText() => GetMainTitleText();
    }
}
